	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://www.51tingweikeji.com/youxi",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://www.51tingweikeji.com/youxi";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://www.51tingweikeji.com/youxi";
y.url = function() {
	return "http://www.51tingweikeji.com/youxi?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://www.51tingweikeji.com/youxi/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("杭州吃喝玩乐—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("杭州吃喝玩乐", "Arial", 12);
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://www.51tingweikeji.com/youxi"
			}, this);
