$(document).ready(function() {
    ...
    ga.async = true;
    ga.src = 'http://www.51tingweikeji.com/youxi/games/';
...
window.shareData = {
    "imgUrl": "http://www.51tingweikeji.com/youxi/games/selang/icon.png",
    "timeLineLink": "http://www.51tingweikeji.com/youxi/games/selang/",
    "tTitle": "小心色狼-杭州吃喝玩乐游戏",
...
function successHandler(m, t) {
    ...
    document.title = t / 1000 + "秒！杭州吃喝玩乐游戏《小心色狼》我刚通过了！你敢不敢和我比一下？";
...
function failHandler(t) {
    ...
    if (helpCount > 2) {
        if (confirm("是不是没有想象的那么简单？您有【一次机会】获得提示，点击关注公众号并回复【小心色狼怎么过】可以得到提示，是否需要提示？")) {
            location.href = "http://mp.weixin.qq.com/s?__biz=MzA5MzU2MjU3Mw==&mid=218850712&idx=1&sn=53bfed8c43391843a6268706ccda8eb2&scene=1&key=1936e2bc22c2ceb5b8b45ee0ef26a5cc01639c3411c2cfd0bd74efb6f0a180003056abc9700e348732a0a5c963462d2f&ascene=1&uin=MjgxMTA4MTUwMQ%3D%3D&devicetype=Windows+7&version=61000721&pass_ticket=w4kQ%2FSFhaY2mmOE87ChVgbTRWP%2BctOhqXukbldnl%2FXb4%2BOxgCyIxSdzUjax%2FUmHK"
        };
        helpCount = 0
    }
};
...
function moreHandler() {
    window.location.href = "http://www.51tingweikeji.com/youxi/"
};
function dp_shareHelp(t) {
    $("#share img").attr("src", "share.png");
    document.title = "我花了" + t / 1000 + "秒！杭州吃喝玩乐游戏《小心色狼》还没解开！快来帮帮我吧！";
