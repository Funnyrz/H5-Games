...
shareData = {
    imgUrl: "http://www.51tingweikeji.com/youxi/games/zhaonimei/zhaonimei.jpg",
    timeLineLink: "http://www.51tingweikeji.com/youxi/games/zhaonimei/",
...
function(a) {
    ...
    f = {
        init: function() {
            this.initEvent(),
            this.loading(),
            /android/i.test(c) ? (b.banner.attr("href", "http://www.51tingweikeji.com/youxi/").data("type", "android").find("img").attr("src", "assets/img/banner.android.jpg"), b.banner.show()) : /iphone|ipad|ipod/i.test(c) && (b.banner.attr("href", "http://www.51tingweikeji.com/youxi/").data("type", "ios").find("img").attr("src", "assets/img/banner.ios.jpg"), b.banner.show())
        },
        loading: function() {
            function a() {
                d++,
